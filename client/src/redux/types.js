...
export const CREATING_LOCATION_COMPLETE = "CREATING_LOCATION_COMPLETE";
...
export const LOADING_CREATE_FORM = "LOADING_CREATE_FORM";
export const STOP_CREATE_FORM = "STOP_CREATE_FORM";
